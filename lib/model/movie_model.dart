...
List<movie> moviesList =[
  ...
  movie(title: 'Rorschach',
      description: 'Luke Anthony is an NRI businessman in Dubai '
          'who goes to Kerala with his pregnant wife Sofia for a vacation.'
          ' While travelling through the forest they have a road accident.'
          ' Upon gaining consciousness, he finds Sofia is missing and reports'
          ' it to the local police. The cops close the case, as they deduce '
          'that Sofia was killed by a tiger. Luke decides to find her on his own.'
          ' Luke stumbles upon Balan, who asks him to purchase his house on the outskirts '
          'of the forest. He tells Luke that the house was owned by his elder son,'
          ' Dilip Balan, who died in an accident, a few months ago.',
      actors: ['a,','b','c','d'],
